 ...
 */
public class EventLogger implements RadioPlayer.Listener, RadioPlayer.InfoListener,
        RadioPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[RadioPlayer.RENDERER_COUNT];
  }
